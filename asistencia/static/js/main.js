...
if(direccion.pathname == "/asistencia/asistencia2/" ){
  let jqCdn = '//cdn.jsdelivr.net/npm/sweetalert2@11';
    const div3 = document.querySelector(".object-tools .btn-group").insertAdjacentHTML("afterend",`
        <a href="#" class="import_link btn btn-outline-secondary border-quitar">
            <i class="fas fa-file-import" style="
  ...
  loadJs(jqCdn, () => {
       function accion(){
          ...
          accion1.addEventListener('click', async function(){              
              ...
              Swal.fire({
                width: 1020,
                html: `<iframe width="920" height="850" src="${direccion.origin+'/index2'}" frameborder="0" allowfullscreen></iframe>`,
                showCloseButton: true,
                showCancelButton: true,
                focusConfirm: false,
            });
...
if(direccion.pathname == "/asistencia/empleado_datos/" ){
  let jqCdn = '//cdn.jsdelivr.net/npm/sweetalert2@11';
    const div3 = document.querySelector(".object-tools .btn-group").insertAdjacentHTML("afterend",`
        <a href="#" class="import_link btn btn-outline-secondary border-quitar">
            <i class="fas fa-file-import" style="
  ...
  loadJs(jqCdn, () => {
       function accion(){
          ...
          accion1.addEventListener('click', async function(){              
              ...
              Swal.fire({
                width: 1020,
                html: `<iframe width="920" height="850" src="${direccion.origin+'/ap_personal'}" frameborder="0" allowfullscreen></iframe>`,
                showCloseButton: true,
                showCancelButton: true,
                focusConfirm: false,
            });
